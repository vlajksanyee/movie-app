...
protocol MediaDetailsViewModelProtocol: ObservableObject {
    var media: MediaDetailsResponse? { get }
}

class MediaDetailsViewModel: MediaDetailsViewModelProtocol, ErrorPresentable {
    @Published var media: MediaDetailsResponse? = nil
    ...
    init() {
        ...
        mediaIdSubject
            .flatMap { [weak self] mediaId -> AnyPublisher<MediaDetailsResponse, MovieError> in
